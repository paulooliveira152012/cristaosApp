...
export default function Menu() {
  ...
  const [verificationNotificationModal, setVerificationNotificationModal] =
    useState(false);
          ...
          <>
            ...
            {selectedPage === "login" && (
              <View style={styles.formContainer}>
                ...
                {modal && (
                  <View>
                    <ThemedText>
                      Please verify your account through the email we've sent
            ...
            {selectedPage === "signup" && (
              <View style={styles.formContainer}>
                ...
                <TextInput
                  style={styles.input}
                  placeholder="Ministry Involvement (e.g., Worship, Youth, Outreach)"
                  value={ministry}
                ...
                <TextInput
                  style={styles.input}
                  placeholder="Twitter Handle (Optional) - e.g., @yourhandle"
                  value={twitterHandle}
